...
label1 = Label(root, width=7, text='Produto',
               font=('Arial', 15)).place(x=8, y=50)
label1 = Label(root, width=7, text='Preço',
               font=('Arial', 15)).place(x=8, y=90)
...
Button(root, text="salvar", font=('Arial', 12),
       bg="white", command=salvar).place(x=150, y=150)
root.mainloop()
